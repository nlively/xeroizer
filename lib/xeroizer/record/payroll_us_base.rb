module Xeroizer
  module Record
    ...
    class PayrollUSBase < Xeroizer::Record::Base
      ...
      def self.belongs_to(field_name, options = {})
        super(field_name, {:base_module => Xeroizer::Record::Payroll::US}.merge(options))
      end
      ...
      public
        ...
        def new_model_class(model_name)
          Xeroizer::Record::Payroll::US.const_get("#{model_name}Model".to_sym).new(parent.application, model_name.to_s)
        end
